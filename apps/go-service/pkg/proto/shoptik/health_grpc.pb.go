...
const (
	HealthService_Check_FullMethodName   = "/shoptik.HealthService/Check"
	HealthService_GetInfo_FullMethodName = "/shoptik.HealthService/GetInfo"
)
...
type HealthServiceClient interface {
	...
	// Get service info
	GetInfo(ctx context.Context, in *ServiceInfoRequest, opts ...grpc.CallOption) (*ServiceInfoResponse, error)
}
...
func (c *healthServiceClient) GetInfo(ctx context.Context, in *ServiceInfoRequest, opts ...grpc.CallOption) (*ServiceInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type HealthServiceServer interface {
	...
	// Get service info
	GetInfo(context.Context, *ServiceInfoRequest) (*ServiceInfoResponse, error)
...
func (UnimplementedHealthServiceServer) GetInfo(context.Context, *ServiceInfoRequest) (*ServiceInfoResponse, error) {
...
func _HealthService_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).GetInfo(ctx, req.(*ServiceInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shoptik.HealthService",
