...
const logEntries: LogEntry[] = [
  {
    level: "INFO",
    timestamp: "12:13:47.112",
    service: "order-logs",
    message: "Order #73ef718f created by user — total: $434",
    animClass: "animate-log-1",
  },
  {
    level: "INFO",
    timestamp: "12:13:48.334",
    service: "payment-svc",
    message: "PAYMENT_SUCCESS: Transaction TXN1775218092555V3NDVV",
    animClass: "animate-log-2",
  },
  {
    level: "WARN",
    timestamp: "12:13:50.004",
    service: "order-svc",
    message: "Stock update: SKU-992 reduced by 2 units",
    animClass: "animate-log-3",
  },
  {
    level: "INFO",
    timestamp: "12:13:52.890",
    service: "notify-svc",
    message: "WebSocket push: order #73ef718f status changed to PROCESSING",
    animClass: "animate-log-4",
  },
  {
    level: "ERROR",
    timestamp: "12:13:55.210",
    service: "payment-svc",
    message: "PAYMENT_FAILED: Insufficient balance for order #92fa31b",
    animClass: "animate-log-5",
  },
  {
    level: "INFO",
    timestamp: "12:13:58.001",
    service: "order-logs",
    message: "STATUS_CHANGED: Order #f050c373 delivered by admin",
